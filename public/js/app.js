...
if (applyBtn) {
  applyBtn.addEventListener('click', function (e) {
    ...
    console.log(code);
    Object(_script__WEBPACK_IMPORTED_MODULE_3__["initPromo"])(code);
  });
} //initAdmin()
// change order status
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (data === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_4___default()(order.updatedAt).format('MMM Do YYYY,hh:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    type: "warning",
    text: 'Status changed' //timeout: 1000
...
__webpack_require__(/*! D:\node-js\realtime-foodapp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\node-js\realtime-foodapp\resources\scss\app.scss */"./resources/scss/app.scss");
