...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (data === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('MMM Do YYYY,hh:mm A');
